...
; Jonathan Winters
;
; Description: Sample bubble sort code
;
...
;	ShowProggress work2				; macro that displays work2
	...
	mCnvrt_and_cmp work1, work2		; macro that converts into integers and then compares, returning a 1 (if work1 is bigger) or a 0 (if work2 is bigger)
	cmp		eax, 0
	je		WORK1_SMALLER			; if zero, then 1st string is smaller
